...
{
    public class PhotoAggregate : ICommandHandler<UploadPhotoCommand>, ICommandHandler<UploadPhotosFromFolderCommand>
    {
        ...
        Unit IRequestHandler<UploadPhotosFromFolderCommand, Unit>.Handle(UploadPhotosFromFolderCommand message)
        {
